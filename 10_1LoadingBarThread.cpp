...
void show_loading_bar(int progress, int totalProgress)
{
    const int barWidth = 40;
    float progressRatio = static_cast<float>(progress) / totalProgress;
...
double calculate_pi(int n)
{
    ...
    for (int i = 0; i < n; i++)
    {
        ...
        //Update progress
        ++currentProgress;
        show_loading_bar(currentProgress, totalProgress);
    }
    cout<<"FINISHED !"<<endl;
    return sum*4;
